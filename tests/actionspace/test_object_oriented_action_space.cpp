...
public:
    ...
    void SetUp() {
        m_actionspace.generate_actions(
            Eigen::Vector2d(100, 200), 2 - (4 * M_PI));
    }
...
TEST_F(SimpleOOActionFixture, ActionGenerationTest) {
    ...
    EXPECT_NEAR(0.429204, action->getTheta(), 0.000001);
    ...
    EXPECT_NEAR(5.14159, action->getTheta(), 0.00001);
    EXPECT_EQ(0, action->getSpeed());
    EXPECT_EQ(5, action->getDuration());
    ...
    EXPECT_NEAR(3.57079, action->getTheta(), 0.00001);
    EXPECT_EQ(2.5, action->getSpeed());
